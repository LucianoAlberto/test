     ...
     <div>
         <div class="max-w-6xl mx-auto py-10 sm:px-6 lg:px-8">
             <div class="mt-5 md:mt-0 md:col-span-2" id="contenedorPrincipal">
                 ...
                 <form method="post" action="{{ route('asistencias.update',[$empleado,$asistencia]) }}" enctype="multipart/form-data" class="flex justify-center">
                     @csrf
                     @method('PUT')
                     <div class="shadow overflow-hidden sm:rounded-md w-1/2">
                         <h3 class="text-center font-bold uppercase w-full py-4 bg-gray-300">Editando fichero assistencia {{$asistencia->id}}</h3> 
