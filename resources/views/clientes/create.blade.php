<x-app-layout>
    <div>
                        ...
                        <div class="px-4 py-5 bg-white sm:p-6 divide-y-4">
                            <div class="divDatosPersonales mb-4">
                                ...
                                <div class="flex justify-between mb-8">
                                    <div class="w-3/6 mr-2">
                                        <label for="direccion_fiscal"
                                            class="block font-medium text-sm text-gray-700">Dirección fiscal </label>
                                    ...
                                    <div class="w-3/6 ml-2">
                                        <label for="domicilio"
                                            class="block font-medium text-sm text-gray-700">Domicilio</label>
                                ...
                                <div class="flex justify-between mb-8">
                                    <div class="w-2/5 mr-2">
                                        <label for="nombre_comercial"
                                            class="block font-medium text-sm text-gray-700">Nombre comercial* </label>
                                    ...
                                    <div class="w-2/5 mr-2 ml-2">
                                        <label for="nombre_sociedad"
                                            class="block font-medium text-sm text-gray-700">Nombre sociedad *</label>
                                        <input type="text" name="nombre_sociedad" id="nombre_sociedad"
                                            class="form-input rounded-md shadow-sm mt-1 block w-full"
                                ...
                                <div class="flex justify-between mb-8">
                                    <div class="w-3/6 mr-2">
                                        <label for="cuenta_bancaria"
                                            class="block font-medium text-sm text-gray-700">Cuenta bancaria *</label>
                                        <input type="text" name="cuenta_bancaria" id="cuenta_bancaria"
                                            class="form-input rounded-md shadow-sm mt-1 block w-full"
                                            value="{{ old('cuenta_bancaria', '') }}"
                                            placeholder="ES-XX-XXXX-XXXX-XX-XXXXXXXXXX" maxlength="29"
                                            onkeyup="mascaraIban()" />
                                    ...
                                    <div class="w-3/6 ml-2">
                                        <label for="n_tarjeta" class="block font-medium text-sm text-gray-700">Número de
                                            tarjeta *</label>
                                        <input type="text" name="n_tarjeta" id="n_tarjeta"
                                            class="form-input rounded-md shadow-sm mt-1 block w-full"
                                            value="{{ old('n_tarjeta', '') }}" onkeyup="numero_tarjeta()"
                                ...
                                <div class="flex justify-between mb-8">
                                    <div class="w-3/6 mr-2">
                                        <label for="email"
                                            class="block font-medium text-sm text-gray-700">E-mail *</label>
                                    ...
                                    <div class="w-2/6 ml-2 mr-2">
                                        <label for="telefono"
                                            class="block font-medium text-sm text-gray-700">Teléfono *</label>
                                    ...
                                    <div class="w-1/6 ml-2">
                                        <label for="anho_contable" class="block font-medium text-sm text-gray-700">Año
                                            contable *</label>
                                        <input type="text" name="anho_contable" id="anho_contable"
                                            class="form-input rounded-md shadow-sm mt-1 block w-full"
        ...
        @if (session('ambito_creado') == 'si')
            ...
            @elseif (session('ambito_eliminado') == 'si')
                <script>
                    Swal.fire({
                        position: 'center',
                        icon: 'success',
