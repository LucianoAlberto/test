...
<!---Fin menu superior-->
                                    ...
                                    <div class="shadow overflow-hidden border-b border-gray-200 sm:rounded-lg">
                                        <table class="min-w-full divide-y divide-gray-200 w-full ">
                                            <h3 class="text-center font-bold uppercase w-full py-5 bg-gray-300">
                                                <x-boton2 tipo="link" class="bg-gray-800 hover:bg-gray-700 flex justify-around px-5 h-9" direccion="{{ route('asistencias.create', $empleado) }}">
                                                    <x-slot name="boton">
                                                        Añadir Asistencias
                                                        <svg  class="ml-5" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-calendar"><rect x="3" y="4" width="18" height="18" rx="2" ry="2"></rect><line x1="16" y1="2" x2="16" y2="6"></line><line x1="8" y1="2" x2="8" y2="6"></line><line x1="3" y1="10" x2="21" y2="10"></line></svg>
                                                    </x-slot>
                                                </x-boton2>  
                                            </h3>
                                            <thead>
                                            ...
                                            @foreach ($asistencias as $asistencia)
                                                <tr class="hover:bg-green-200">
                                                    ...
                                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium flex items-start">
                                                        <x-boton2 tipo="link" class="bg-yellow-400 hover:bg-yellow-600 mr-4 w-14 h-14" direccion="{{ route('asistencias.edit', [$empleado,$asistencia]) }}">
                                                            <x-slot name="boton">
    ...
    <script>
        Swal.fire({
            position: 'center',
            icon: 'success',
            title: 'Fichero subido con exito',
...
@elseif (session('eliminado') == 'si')
    <script>
        Swal.fire({
            position: 'center',
            icon: 'success',
            title: 'Fichero asistencias Eliminado',
            showConfirmButton: false,
            timer: 1500
        })
    </script>
