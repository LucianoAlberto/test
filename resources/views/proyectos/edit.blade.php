...
<x-slot name="header">
    <div class="flex justify-between ">
        ...
        <div class="flex justify-end ">
            ...
            <div class="block  mx-2">
                <a href="{{route('pagos.index',$proyecto->cliente)}}" class="bg-gray-200 hover:bg-gray-300 text-black font-bold py-2 px-4 rounded">Pagos</a>
            </div>
        </div>
    </div>
    </x-slot>
                                ...
                                <div class="flex justify-between mb-4">
                                    <div class="w-1/3">
                                        <label for="concepto"
                                            ...
                                            <x-boton2 tipo="div" class="ml-1 bg-gray-800 hover:scale-125 hover:bg-gray-700 w-6 h-6 fill-none " onclick="nuevoConcepto()">
                                                <x-slot name="boton">
