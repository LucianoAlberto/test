            ...
            <div class="mt-5 md:mt-0 md:col-span-2" id="contenedorPrincipal">
                <form method="post" action="{{ route('faltas.store', $empleado) }}" enctype="multipart/form-data">
                    ...
                    <div class="shadow overflow-hidden sm:rounded-md">
                        <h3 class="text-center font-bold uppercase w-full py-4 bg-gray-300">Nuevo falta</h3>
                            ...
                            <div class=" justify-between mb-4">
                                <div class="">
                                    ...
                                    <div class="w-full  mb-4">
                                        ...
                                        rows="10" placeholder="Introduzca los motivos de su falta">{{ old("notas", '') }}</textarea>
                                        @error('notas')
                                            <p class="text-sm text-red-600">{{ $message }}</p>
                                        @enderror
                                    </div>                                 
