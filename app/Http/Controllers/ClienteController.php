...
class ClienteController extends Controller
{
    ...
    public function proyectos(Cliente $cliente){
        ...
        //obtenemos todos los proyectos de la BD
       $proyectos=$cliente->proyectos;

     return view('clientes.proyectos',compact('cliente','conceptos','proyectos'));
    }

    public function crearProyecto(Cliente $cliente, Request $request){
        //obtenemos todos los conceptos de la BD
        $conceptos=ConceptoFactura::all(['id','nombre']);
        ...
        $proyecto->provedor_dominio_usuario=$valido['provedor_dominio_usuario'];
        $proyecto->provedor_dominio_password=$valido['provedor_dominio_password'];
        $proyecto->provedor_hosting_usuario=$valido['provedor_hosting_usuario'];
        $proyecto->provedor_hosting_password=$valido['provedor_hosting_password'];
