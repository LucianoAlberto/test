<x-app-layout>
    ...
    <x-slot name="header">
        ...
        <div class="pl-8 ml-8 mt-4 flex justify-start">
            <x-boton2 tipo="div" class="bg-green-600 hover:bg-green-700 flex justify-around w-44" onclick="anadirFactura()">
                <x-slot name="boton">
                    Añadir factura
    ...
    <div class="w-full max-w-xs  m-auto"  id='nueva_factura' hidden >
        <div class="flex justify-center relative ">
            ...
            <x-boton2 tipo="div" class=" absolute right-0 bg-red-600 hover:bg-red-700 w-6 h-6 " onclick="cerrarNuevaFactura()">
                <x-slot name="boton">
                                ...
                                <div class="py-2 align-middle inline-block min-w-full sm:px-6 lg:px-8">
                                    <div class="shadow overflow-hidden border-b border-gray-200 sm:rounded-lg">
                                        <table class="min-w-full divide-y divide-gray-200 w-full ">
                                            <h3 class="text-center font-bold uppercase w-full py-5 bg-gray-300">Facturas</h3>
                                            <thead>
                                            <tr >
                                            ...
                                            @foreach ($cliente->facturas as $factura)
                                                <tr class="hover:bg-green-200 cursor-pointer"  onclick="detalles('{{ route('facturas.show', ['cliente' => $cliente->id, 'factura' => $factura->id]) }}', event)">
                                                    ...
                                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900 text-center">
                                                        <x-boton2 tipo="linkConAsset" class="bg-blue-500 hover:bg-blue-700 w-16 h-12" direccion="{{$factura->factura}}">
                                                            <x-slot name="boton">
