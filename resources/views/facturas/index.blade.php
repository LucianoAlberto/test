        ...
        <form class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4"
            ...
            <div class="mb-4">
                ...
                <input
                    ...
                    id="fecha_cargo" type="date" name="fecha_cargo" required>
                @error('fecha')
            ...
            <div class="mb-4">
                ...
                <input
                    ...
                    id="factura" type="file" name="factura" required>
                @error('factura')
                    <p class="text-sm text-red-600">{{ $message }}</p>
                @enderror
            </div>
            ...
            <div class="mb-3">
                ...
                <select
                    class="shadow appearance-none border border-black rounded w-full py-2 px-3 text-gray-700 mb-3 leading-tight focus:outline-none focus:shadow-outline"
                    id="referencia" name="referencia_contrato" required>
                            ...
                            <div class="py-2 align-middle inline-block min-w-full sm:px-6 lg:px-8">
                                <div class="shadow overflow-hidden border-b border-gray-200 sm:rounded-lg">
                                    <table class="min-w-full divide-y divide-gray-200 w-full ">
                                        <h3 class="text-center font-bold uppercase w-full py-5 bg-gray-300">Facturas
                                        </h3>
                                        <thead>
                                            <tr>
