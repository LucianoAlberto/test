...
window.masFactura = function (event) {
  var divFactura = event.target.closest(".divFacturas").querySelector(".contenedorFacturas").cloneNode(true);
...
window.menosFactura = function (event) {
  var ultimoHijoContenedorContrato = event.target.closest(".contenedorContrato").lastElementChild;
  var listaContenedoresFacturas = event.target.closest(".contenedorContrato").querySelectorAll(".contenedorFacturas");
...
var contador_contratos = 0;

window.masContrato = function (event) {
  contador_contratos++;
  var contenedorContratos = event.target.closest(".divContratos").querySelector(".contenedorContratos").cloneNode(true);
  var divFacturas = contenedorContratos.querySelectorAll(".contenedorFacturas");
  console.log(divFacturas.length);

  for (var i = 1; i <= divFacturas.length - 1; i++) {
  ...
  var inputs = contenedorContratos.querySelectorAll("input");
  inputs.forEach(function (input) {
    input.value = null;
  });
  var numero_contador_contratos = contador_contratos + 1;
...
window.menosContrato = function (event) {
  contador_contratos--;
  var ultimoHijoContenedorContrato = document.getElementById("divContrato").parentElement.lastElementChild; //console.log(document.getElementById("divContrato").parentElement.lastElementChild);

  var listaContenedoresContrato = document.getElementById("divContrato").parentElement.querySelectorAll(".contenedorContrato");
...
window.masFacturaIndependiente = function (event) {
  var divFactura = document.getElementById("divFacturasIndependientes").querySelector(".contenedorFacturasIndependientes").cloneNode(true);
...
window.menosFacturaIndependiente = function (event) {
  var ultimoHijoContenedorContrato = document.getElementById("divFacturasIndependientes").lastElementChild;
  var listaContenedoresFacturasIndependientes = document.getElementById("divFacturasIndependientes").querySelectorAll(".contenedorFacturasIndependientes");
...
window.menosBasesDatos = function (event) {
  var ultimoHijoContenedorBaseDatos = event.target.closest(".divBasesDatos").lastElementChild;
  var listaContenedoresBaseDatos = event.target.closest(".divBasesDatos").querySelectorAll(".contenedorBasesDatos");
...
window.masProyecto = function (event) {
  contador_proyectos++;
  var divContenedorProyectos = document.getElementById("divProyectos").querySelector(".contenedorProyectos").cloneNode(true);
  var numero_contador_proyectos = contador_proyectos + 1;
  divContenedorProyectos.querySelector("h3").innerText = "Proyecto " + numero_contador_proyectos;
  divContenedorProyectos.querySelectorAll("input").forEach(function (input) {
    input.value = null;
  ...
  var divDominios = divContenedorProyectos.querySelectorAll(".contenedorNombreDominio");

  for (var i = 1; i <= divDominios.length - 1; i++) {
  ...
  var divBD = divContenedorProyectos.querySelectorAll(".contenedorBasesDatos");

  for (var _i = 1; _i <= divBD.length - 1; _i++) {
    divBD[_i].remove();
  }
  ...
  var divEmails = divContenedorProyectos.querySelectorAll(".contenedorEmails");

  for (var _i2 = 1; _i2 <= divEmails.length - 1; _i2++) {
    divEmails[_i2].remove();
  }
  ...
  var divAccesos = divContenedorProyectos.querySelectorAll(".contenedorAccesos");

  for (var _i3 = 1; _i3 <= divAccesos.length - 1; _i3++) {
    divAccesos[_i3].remove();
  }
...
window.menosProyecto = function (event) {
  contador_proyectos--;
  var ultimoHijoContenedorAccesos = document.getElementById("divAccesos").lastElementChild;
  var listaContenedoresAccesos = document.getElementById("divAccesos").querySelectorAll(".contenedorAccesos");
...
window.nuevaBD = function () {
  var div = document.getElementById('contenedorPrincipal').querySelector('.contenedor_BBDD').cloneNode(true);
...
window.nuevoEmail = function () {
  var div = document.getElementById('contenedorPrincipal').querySelector('.contenedor_mail').cloneNode(true);
  div.querySelectorAll('input').forEach(function (input) {
    input.value = "";
  });
...
window.nuevoAccesso = function () {
  var div = document.getElementById('contenedorPrincipal').querySelector('.contenedor_accesso').cloneNode(true);
  div.querySelectorAll('input').forEach(function (input) {
    input.value = "";
  });
...
window.mascaraIban = function () {
  var entradaIban = document.getElementById('cuenta_bancaria');
...
window.numero_tarjeta = function () {
  var entradaIban = document.getElementById('n_tarjeta');
