    ...
    <div>
        <div class="max-w-4xl mx-auto py-10 sm:px-6 lg:px-8">
            ...
            <div class="mt-5 md:mt-0 md:col-span-2">
                ...
                <form id="formulario" method="post" action="{{ route('empleados.store') }}"
                    enctype="multipart/form-data">
                    @csrf
                    <div class="shadow overflow-hidden sm:rounded-md ">
                        <h3 class="text-center font-bold uppercase w-full py-4 bg-gray-300">Nuevo Empleado</h3>
                        <div class="px-4 py-5 bg-white sm:p-6 divide-y-4">
                            <div class="divDatosPersonales mb-8">
                                <div class="flex justify-between mb-4">
                                    <div class="w-1/2 mr-2">
                                        <label for="nombre" class="block font-medium text-sm text-gray-700">Nombre
                                            *</label>
                                    ...
                                    <div class="w-1/2 ml-2">
                                        <label for="apellidos" class="block font-medium text-sm text-gray-700">Apellidos
                                            *</label>
                                ...
                                <div class="flex justify-between mb-4">
                                    <div class="w-1/2 mr-2">
                                        ...
                                        <input type="text" name="dni"
                                            class="form-input rounded-md shadow-sm mt-1 block w-full" maxlength="9"
                                            value="{{ old('dni', '') }}" maxlength="9" />
                                        @error('dni')
                                            <p class="text-sm text-red-600">{{ $message }}</p>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="w-1/2 ml-2">
                                        ...
                                        <input type="text" name="numero_ss"
                                            class="form-input rounded-md shadow-sm mt-1 block w-full"
                                            value="{{ old('numero_ss', '') }}" maxlength="12" />
                                        @error('numero_ss')
                                            <p class="text-sm text-red-600">{{ $message }}</p>
                                        @enderror
                                    </div>
                                ...
                                <div class="mb-8">
                                    <fieldset>
                                        <legend class="flex mb-3">Ámbitos de trabajo
                                            <x-boton2 tipo="div"
