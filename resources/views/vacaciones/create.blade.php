    ...
    <div>
        <div class="max-w-6xl mx-auto py-10 sm:px-6 lg:px-8">
            <div class="mt-5 md:mt-0 md:col-span-2" id="contenedorPrincipal">
                <form method="post" action="{{ route('vacaciones.store', $empleado) }}" enctype="multipart/form-data" class="flex justify-center">
                    @csrf
                    <div class="shadow overflow-hidden sm:rounded-md w-auto">
                        <div class="px-4 py-5 bg-white sm:p-6 w-auto">
                            <div class="contenedorNominas justify-between mb-4 w-auto">
                                <div class="flex mb-4">
                                    <div class="mr-2 divFechaInicioNomina">
                                    ...
                                    <div class="ml-2 divFechaFinNomina">
