<x-app-layout>
    ...
    <div class="pl-8 ml-8 mt-4 flex justify-between">
        <x-boton2 tipo="link" class="bg-green-600 hover:bg-green-700 flex justify-around w-55 h-10 p-2" direccion="{{ route('empleados.create') }}">
            <x-slot name="boton">
                Añadir empleado
                                        ...
                                        @foreach ($empleados as $empleado)
                                            <tr class="hover:bg-green-200 cursor-pointer" onclick="detalles('{{ route('empleados.show', $empleado->id) }}', event)">
                                                ...
                                                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium flex items-start">
                                                        ...
                                                        direccion="{{ route('empleados.edit', $empleado->id) }}">
