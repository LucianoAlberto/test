    ...
    <div>
        <div class="max-w-4xl mx-auto py-10 sm:px-6 lg:px-8">
            ...
            <div class="w-1/2 max-w-xs  m-auto mt-5 mb-5 bg-gray-300 border-2" id='nuevoConcepto' hidden>
                ...
                <form class="bg-gray-300  rounded mb-4" action="{{ route('conceptos.store') }}" method="POST"
                ...
                <form class="bg-gray-300  rounded  mb-4" action="{{ route('conceptos.eliminar') }}" method="POST"
                    enctype="multipart/form-data">
                    @csrf
                    <div class=" flex justify-between mx-5 place-content-center py-2">
            ...
            <div class="mt-5 md:mt-0 md:col-span-2">
                <form method="post"
                    action="{{ route('contratos.update', ['cliente' => $cliente, 'contrato' => $contrato]) }}"
                    enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <div class="shadow overflow-hidden sm:rounded-md">
                        <h3 class="text-center font-bold uppercase w-full py-5 bg-gray-300">Editando contrato . . .
                        </h3>
                        <div class="px-4 py-5 bg-white sm:p-6">
                            <div class="flex justify-between mb-4">
                                <div class="w-2/5 mr-2">
                                    ...
                                    <select type="text" name="concepto" id="concepto"
