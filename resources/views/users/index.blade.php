<x-app-layout>
    ...
    <div class="pl-8 ml-8 mt-4 flex justify-start">
        <x-boton2 tipo="link" class="bg-green-600 hover:bg-green-700 flex justify-around w-44 h-10 p-2" direccion="{{ route('users.create') }}">
            <x-slot name="boton">
                Añadir usuario
                ...
                <div>
                    <div class="mx-auto pb-10 sm:px-6 lg:px-8">
                        <div class="flex flex-col">
                            <div class="-my-2 overflow-x-auto sm:-mx-6 lg:g-mx-8">
