...
class ClienteRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'cif' => 'required|string|regex:/^([A-Z]{1})(\d{8})/',
    ...
    public function messages(){
        return [
            ...
            'anho_contable.regex' => 'El :attribute no tiene el formato correcto (cuatro dígitos).',
            'direccionFiscal.string' => 'La :attribute es una cadena de caracteres.',
            'domicilio.string' => 'El :attribute es una cadena de caracteres.',
            'nombre_comercial.string' => 'El :attribute es una cadena de caracteres.',
            'nombre_comercial.required' => 'El :attribute es obligatorio.',
            'nombre_sociedad.string' => 'El :attribute es una cadena de caracteres.',
            'nombre_sociedad.required' => 'El :attribute es obligatorio.',
            'cif.string' => 'El :attribute es una cadena de caracteres.',
            'cif.required' => 'El :attribute es obligatorio.',
            'cif.regex' => 'El :attribute no tiene el formato correcto (una letra y 8 dígitos).',
    ...
    public function attributes(){
        return [
            ...
            'nombre_sociedad' => 'nombre de la sociedad del cliente',
            'cif' => 'CIF del cliente',
